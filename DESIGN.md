...
- Pretendard for all UI prose, code blocks, inline code, and type/property signatures
...
### Font Family
**Pretendard** (primary): Variable typeface optimized for Korean and Latin UI legibility. Used across every UI surface — body, headings, navigation, button labels, captions, code blocks, and type signatures. Fallbacks: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif.
...
- **Pretendard** — single typeface for all surfaces including code references; the clean geometry of Pretendard is the brand's developer-respect signal
...
- Use Pretendard consistently across all surfaces — never introduce a second typeface
...
- Don't introduce other typefaces alongside Pretendard — the single-typeface discipline IS the brand voice
